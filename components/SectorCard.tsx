...
export default function SectorCard({
  ...
  return (
    <button
      onClick={onClick}
      className={`sector-card ${positive ? 'positive' : negative ? 'negative' : ''} card-appear group relative rounded-[22px] text-left w-full flex flex-col items-stretch outline-none overflow-hidden focus-visible:ring-2 focus-visible:ring-indigo-400 ${borderHover}`}
    ...
    >
      ...
      <div className="px-4 pt-3.5 pb-3 flex-1 flex flex-col relative z-10">
        ...
        <div className="flex items-center gap-1.5 mb-3">
          ...
          {rankChange !== null && rankChange !== 0 && (
            <span className={`rank-change text-[9px] font-bold tracking-tight px-1.5 py-[2px] rounded-[5px] ${
              rankChange > 0
          ...
          <div className="ml-auto flex items-center gap-1.5">
            ...
            {streak >= 5 && !scorecard && (
              <span className="flex items-center gap-[2px] text-[9px] font-bold text-orange-500/80">
      ...
      <div className="px-4 pt-3 pb-3.5 border-t border-slate-100/80 dark:border-white/10 relative z-10">
        {breadth !== null && (
          <div className="mb-2.5">
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-[9px] uppercase font-bold tracking-[0.09em] text-slate-400 dark:text-slate-500">Breadth</span>
        ...
        <div className="flex items-center justify-between">
          ...
          <span className={`text-[10px] tracking-wide font-bold uppercase opacity-50 group-hover:opacity-100 transition-opacity ${
